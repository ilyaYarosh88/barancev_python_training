...
def test_edit_some_contact(app):
    ...
    contact = Contact(firstname="EditedIvan", middlename="EditedSergeevich", lastname="EditedPetrov", nickname="EditedButthead",
                      title="Editedtest", company="EditedGazprom", address="EditedMoscow", homephone="1111",
                      mobilephone="1111", workphone="1111", fax="1111",
                      ...
                      ayear="2000", address2="EditedMoscow", secondaryphone="1111", notes="EditedTest")
